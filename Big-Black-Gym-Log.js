...
(function () {
    ...
    */
    ...
    const KEYS = { STORAGE: 'bbgl_storage_v1', STATE: 'bbgl_view_state_v1', CONFIG: 'bbgl_config_v1', SESSION: 'bbgl_trained_flag', LAST_SYNC: 'bbgl_last_data_sync_v1', BS_SYNC: 'bbgl_bs_last_sync_v1', API_CREDS: 'bbgl_api_auth_v1', SESSION_CACHE: 'bbgl_session_cache_v1', DEMO: 'bbgl_demo_mode', SB_NOTIF: 'bbgl_sb_notif_seen', DEV_MODE: 'bbgl_dev_mode', CHANGELOG_VER: 'bbgl_changelog_seen_ver', CHANGELOG_NOTIF: 'bbgl_changelog_notif' };
...
/*========================*/                                                  /*========================*/`;
    ...
    */
    ...
    function buildChangelogModalHTML() { const changelogSection = buildSection('BBGL Test Phase Changelog', `<div class="bbgl-modal-scrollbox" style="max-height:calc(68vh - 80px); min-height:250px;"><div style="font-family:Arial,sans-serif; font-size:12px; color:#ccc; line-height:1.7;"><div style="text-align:center; color:#aaa; font-size:13px; margin-bottom:10px; padding-bottom:8px; border-bottom:1px solid #444;">April 25, 2026 &mdash; Version 0.9.10</div><div style="background:rgba(255,200,0,0.07); border:1px solid rgba(255,200,0,0.2); border-radius:4px; padding:6px 9px; margin-bottom:20px; font-size:11px; color:#c8a800; font-style:italic;">&#9888; This changelog will be wiped upon final release.</div><div style="font-weight:700; color:#fff; font-size:13px; letter-spacing:0.8px; text-transform:uppercase; margin-bottom:6px;">New Features</div><div style="margin-bottom:20px;"><div style="margin-bottom:4px;"><span style="color:#555; margin-right:6px;">--</span>Added a Changelog Modal.</div><div style="margin-bottom:4px;"><span style="color:#555; margin-right:6px;">--</span>Added New Sponsorship Sticker Page.</div></div><div style="font-weight:700; color:#fff; font-size:13px; letter-spacing:0.8px; text-transform:uppercase; margin-bottom:6px;">Improvements</div><div style="margin-bottom:20px;"><div style="margin-bottom:4px;"><span style="color:#555; margin-right:6px;">--</span>Improved mobile battlestat navigation by replacing static snapshot tooltips with a tap-and-hold scrubbing interaction, preserving full functionality without obstructing the calendar view. <span style="color:#666; font-style:italic;">(Addressing LatinoBull&rsquo;s feedback)</span></div><div style="margin-bottom:4px;"><span style="color:#555; margin-right:6px;">--</span>Improved clarity for exiting Demo Mode with better visual cues. <span style="color:#666; font-style:italic;">(Addressing Svegarn&rsquo;s feedback)</span></div><div style="margin-bottom:4px;"><span style="color:#555; margin-right:6px;">--</span>Added a tooltip to the footer icon while in page mode informing users of limited panel functionality. <span style="color:#666; font-style:italic;">(Addressing Svegarn&rsquo;s feedback)</span></div><div style="margin-bottom:4px;"><span style="color:#555; margin-right:6px;">--</span>Improved data integrity with proactive integrity checks and more informative error messages.</div><div style="margin-bottom:4px;"><span style="color:#555; margin-right:6px;">--</span>Improved error messaging to provide clearer, more descriptive codes during malfunctions. <span style="color:#666; font-style:italic;">(Because Wulfie is a Boomer)</span></div><div style="margin-bottom:4px;"><span style="color:#555; margin-right:6px;">--</span>Added additional error messaging across sync and storage operations to improve troubleshooting.</div></div><div style="font-weight:700; color:#fff; font-size:13px; letter-spacing:0.8px; text-transform:uppercase; margin-bottom:6px;">Bug Fixes</div><div><div style="margin-bottom:4px;"><span style="color:#555; margin-right:6px;">--</span>Fixed ledger rate continuity so starting rates for a new day correctly match the ending rates of the previous day.</div><div style="margin-bottom:4px;"><span style="color:#555; margin-right:6px;">--</span>Fixed image asset loading failures for users in the UK and internationally. <span style="color:#666; font-style:italic;">(Addressing DonCorleone and ApexJP&rsquo;s reports)</span></div><div style="margin-bottom:4px;"><span style="color:#555; margin-right:6px;">--</span>Fixed the expanded panel compress/expand toggle icon not rendering correctly.</div><div style="margin-bottom:4px;"><span style="color:#555; margin-right:6px;">--</span>Fixed a critical data merge bug that caused errors or corruption when importing a log with gaps in history.</div></div></div></div>`, 'margin-bottom:8px;'); return `<div class="bbgl-modal-overlay" id="bbgl-changelog-modal"><div class="bbgl-modal-window"><div class="close-settings-btn bbgl-close-x" id="bbgl-changelog-close" title="Close">${ICONS.CLOSE}</div>${changelogSection}</div></div>`; }
