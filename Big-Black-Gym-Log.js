...
(function () {
    ...
    */
    ...
    const CUSTOM_STICKERS = [
        //Sweat Equity
        { id: 1, name: "Just Checking the Mirror", url: _d('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0JpZ0JsYWNrSGF3azQyMDY5L2FzZGZhc2tpamRuZmF3ZWYvbWFpbi9HeW0vSnVzdCUyMENoZWNraW5nJTIwdGhlJTIwTWlycm9yJTIwLSUyMFJlZG8ucG5n') }, { id: 2, name: "Up, Down, Repeat", url: _d('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0JpZ0JsYWNrSGF3azQyMDY5L2FzZGZhc2tpamRuZmF3ZWYvbWFpbi9HeW0vVXAsJTIwRG93biwlMjBSZXBlYXQlMjAtJTIwUmVkby5wbmc=') }, { id: 3, name: "Flat Bench Therapy", url: _d('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0JpZ0JsYWNrSGF3azQyMDY5L2FzZGZhc2tpamRuZmF3ZWYvbWFpbi9HeW0vRmxhdCUyMEJlbmNoJTIwVGhlcmFweSUyMC0lMjBSZWRvLnBuZw==') }, { id: 4, name: "Bring Home the Feed", url: _d('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0JpZ0JsYWNrSGF3azQyMDY5L2FzZGZhc2tpamRuZmF3ZWYvbWFpbi9HeW0vQnJpbmclMjBIb21lJTIwdGhlJTIwRmVlZCUyMC0lMjBSZWRvLnBuZw==') }, { id: 5, name: "Never Skip Leg Day", url: _d('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0JpZ0JsYWNrSGF3azQyMDY5L2FzZGZhc2tpamRuZmF3ZWYvbWFpbi9HeW0vTmV2ZXIlMjBTa2lwJTIwTGVnJTIwRGF5JTIwLSUyMFJlZG8ucG5n') }, { id: 6, name: "Tire Rotation", url: _d('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0JpZ0JsYWNrSGF3azQyMDY5L2FzZGZhc2tpamRuZmF3ZWYvbWFpbi9HeW0vVGlyZSUyMFJvdGF0aW9uJTIwLSUyMFJlZG8ucG5n') }, { id: 7, name: "Back End Engagement", url: _d('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0JpZ0JsYWNrSGF3azQyMDY5L2FzZGZhc2tpamRuZmF3ZWYvbWFpbi9HeW0vQmFjayUyMEVuZCUyMEVuZ2FnZW1lbnQlMjAtJTIwUmVkby5wbmc=') }, { id: 8, name: "The Upside of Exercise", url: _d('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0JpZ0JsYWNrSGF3azQyMDY5L2FzZGZhc2tpamRuZmF3ZWYvbWFpbi9HeW0vVGhlJTIwVXBzaWRlJTIwb2YlMjBFeGVyY2lzZSUyMC0lMjBSZWRvLnBuZw==') }, { id: 9, name: "Shellshock Stretches", url: _d('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0JpZ0JsYWNrSGF3azQyMDY5L2FzZGZhc2tpamRuZmF3ZWYvbWFpbi9HeW0vU2hlbGxzaG9jayUyMFN0cmV0Y2hlcyUyMC0lMjBSZWRvLnBuZw==') }, { id: 10, name: "Certified Cardio", url: _d('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0JpZ0JsYWNrSGF3azQyMDY5L2FzZGZhc2tpamRuZmF3ZWYvbWFpbi9HeW0vQ2VydGlmaWVkJTIwQ2FyZGlvJTIwLSUyMFJlZG8ucG5n') },
        //Casino Collection    
        { id: 11, name: "Just One More Spin", url: _d('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0JpZ0JsYWNrSGF3azQyMDY5L2FzZGZhc2tpamRuZmF3ZWYvbWFpbi9DYXNpbm8vSnVzdCUyME9uZSUyME1vcmUlMjBTcGluLnBuZw==') }, { id: 12, name: "Bingo! I Think...", url: _d('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0JpZ0JsYWNrSGF3azQyMDY5L2FzZGZhc2tpamRuZmF3ZWYvbWFpbi9DYXNpbm8vQmluZ28hJTIwSSUyMHRoaW5rLi4uLnBuZw==') }, { id: 13, name: "Lucky Shot", url: _d('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0JpZ0JsYWNrSGF3azQyMDY5L2FzZGZhc2tpamRuZmF3ZWYvbWFpbi9DYXNpbm8vTHVja3klMjBTaG90LnBuZw==') }, { id: 14, name: "Holy Craps", url: _d('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0JpZ0JsYWNrSGF3azQyMDY5L2FzZGZhc2tpamRuZmF3ZWYvbWFpbi9DYXNpbm8vSG9seSUyMENyYXBzLnBuZw==') }, { id: 15, name: "Tilted in My Favor", url: _d('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0JpZ0JsYWNrSGF3azQyMDY5L2FzZGZhc2tpamRuZmF3ZWYvbWFpbi9DYXNpbm8vVGlsdGVkJTIwaW4lMjBNeSUyMEZhdm9yLnBuZw==') }, { id: 16, name: "Choose Wisely", url: _d('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0JpZ0JsYWNrSGF3azQyMDY5L2FzZGZhc2tpamRuZmF3ZWYvbWFpbi9DYXNpbm8vQ2hvb3NlJTIwV2lzZWx5LnBuZw==') }, { id: 17, name: "Hit Me", url: _d('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0JpZ0JsYWNrSGF3azQyMDY5L2FzZGZhc2tpamRuZmF3ZWYvbWFpbi9DYXNpbm8vSGl0JTIwTWUucG5n') }, { id: 18, name: "Dead Men's Hand", url: _d('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0JpZ0JsYWNrSGF3azQyMDY5L2FzZGZhc2tpamRuZmF3ZWYvbWFpbi9DYXNpbm8vRGVhZCUyME1lbidzJTIwSGFuZC5wbmc=') }, { id: 19, name: "Trigger Warning", url: _d('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0JpZ0JsYWNrSGF3azQyMDY5L2FzZGZhc2tpamRuZmF3ZWYvbWFpbi9DYXNpbm8vVHJpZ2dlciUyMFdhcm5pbmcucG5n') }, { id: 20, name: "Leslie's Sick Day", url: _d('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0JpZ0JsYWNrSGF3azQyMDY5L2FzZGZhc2tpamRuZmF3ZWYvbWFpbi9DYXNpbm8vTGVzbGllJ3MlMjBTaWNrJTIwRGF5LnBuZw==') }];
          ...
          /*================================================================================*/
               /*======================================================================*/
                 ...
                 /*==================================================================*/
                    ...
                    grid-template-rows:auto auto; width:100%; flex:1; /*-------*/
                    align-content:start; /*-----------------------------------*/
                    ...
                    #bbgl-panel.bbgl-expanded:not(.bbgl-mode-page) .ui-floating-label, #bbgl-panel.bbgl-expanded:not(.bbgl-mode-page) .ui-floating-summary { font-size:13px!important;
                    } /*------------------------------------------------------*/
                    ...
                    #bbgl-sponsor-grid { position:relative; display:grid; /*-*/
                    grid-template-columns:repeat(3,1fr); /*------------------*/
                    grid-template-rows:1fr; width:100%; flex:1; /*-----------*/
                    align-content:center; align-items:center; /*------------*/
                    justify-items:center; padding:0; gap:0px; /*------------*/
                    margin:0 -6px; } /*---------------------------------------*/
                    .bbgl-expanded #bbgl-sponsor-grid { gap:1px; /*--------*/
                    padding:0 1px; margin:0 -3px; } /*----------------------*/
                    ...
                    padding:0!important; margin:0 -10px!important; } /*-----*/
                    .sticker-slot-sponsor { height:92px; width:100%; /*-----*/
                    max-width:102px; position:relative; display:flex; /*---*/
                    align-items:center; justify-content:center; /*---------*/
                    overflow:visible; } /*-----------------------------------*/
                    .bbgl-expanded .sticker-slot-sponsor { height:145px; /*-*/
                    max-width:160px; } /*----------------------------------*/
                    #bbgl-panel.bbgl-expanded.bbgl-mode-page .sticker-slot-sponsor { height:172px;
                    max-width:192px; } /*----------------------------------*/
                    ...
                    opacity:0.9; } /*--------------------------------------*/
                    .sponsor-sticker-label { position:absolute; top:50%; /*-*/
                    left:50%; transform:translate(-50%,-50%); /*-----------*/
                    font-family:'Fjalla One',sans-serif; font-size:9px; /*-*/
                    ...
                    box-shadow:0 0 6px rgba(255,215,0,0.85)!important; /*--*/
                    transform:scale(1.3); } /*------------------------------*/
...
/*========================*/                                                  /*========================*/`;
    ...
    */
    ...
    function openChangelogModal() { closeChangelogModal(); document.body.insertAdjacentHTML('beforeend', buildChangelogModalHTML()); const modal = document.getElementById('bbgl-changelog-modal'); if (!modal) return; localStorage.setItem(KEYS.CHANGELOG_VER, SCRIPT_VERSION); localStorage.removeItem(KEYS.CHANGELOG_NOTIF); syncChangelogNotif(false); modal.querySelector('#bbgl-changelog-close').onclick = () => closeChangelogModal(); modal.onclick = (e) => { if (e.target === modal) closeChangelogModal(); }; }
    ...
    */
    const GraphController = {
        _transformData({ selectedData, selectedLabel, year, graphMode }) {
            const isToday = !selectedData, lbl = selectedLabel || ""; let vt = 'DAY', sl = null; if (isToday) { sl = DataController.getSlice('DAY', Formatter.dateLogical()); vt = 'DAY'; } else if (lbl === 'All-Time') { sl = DataController.getSlice('ALL', 'All-Time'); vt = 'ALL'; } else if (/^\d{4}-\d{2}-\d{2}$/.test(lbl)) { sl = DataController.getSlice('DAY', lbl); vt = 'DAY'; } else if (/^\d{4}$/.test(lbl)) { sl = DataController.getSlice('YEAR', lbl); vt = 'YEAR'; } else if (CONSTANTS.MONTHS.includes(lbl)) { sl = DataController.getSlice('MONTH', lbl, year); vt = 'MONTH'; } else { sl = selectedData; vt = 'WEEK'; } if (!sl) return { labels: [], trends: { str: [], def: [], spd: [], dex: [], total: [] }, viewType: vt, xParams: { min: 0, max: 0 } }; const isR = graphMode === 'rates', labs = [], tr = { str: [], def: [], spd: [], dex: [], total: [] }, xp = { min: 0, max: 0 }, st = STAT_KEYS, tl = DataController.getTimeline(), h = getActiveHistory(); let sr = { ...ZERO_BREAKDOWN, total: 0 }, startTs = 0; if (vt === 'DAY') { const _p = sl.date.split('-'); startTs = TimeManager.dayStartTs(sl.date); } else if (vt === 'MONTH') { startTs = new Date(Date.UTC(year, CONSTANTS.MONTHS.indexOf(lbl), 1)).getTime(); } else if (vt === 'YEAR') { startTs = new Date(Date.UTC(parseInt(lbl), 0, 1)).getTime(); } else if (vt === 'ALL' && sl._dailyList.length > 0) { startTs = Formatter.parse(sl._dailyList[0].date).getTime(); } else if (sl._dailyList.length > 0) { startTs = Formatter.parse(sl._dailyList[0].date).getTime(); } const _histCut = sl.date || (sl._dailyList?.[0]?.date) || ''; const hist = tl.filter(d => _histCut ? d.date < _histCut : new Date(d.date + 'T00:00:00Z').getTime() < startTs).reverse(); if (_histCut) { const _prevDate = new Date(_histCut + 'T00:00:00Z'); _prevDate.setUTCDate(_prevDate.getUTCDate() - 1); const _prevDateStr = _prevDate.toISOString().slice(0, 10); st.forEach(s => { sr[s] = DataController.getHistoricalRate(_prevDateStr, s); }); } else { const _or = (h.meta && h.meta.originRates) || {}; st.forEach(s => { sr[s] = _or[s] || 0; }); } sr.total = st.reduce((a, b) => a + (sr[b] || 0), 0); const globalBaseline = (h.meta && h.meta.baselineBreakdown) || { ...ZERO_BREAKDOWN }; const _hv = (o) => o && (o.str || o.def || o.spd || o.dex); const _updRates = (d, base) => { let ur = { ...base }; const ser = (d && d.series) || []; st.forEach(s => { for (let j = ser.length - 1; j >= 0; j--) { const e = ser[j]; if (e.stat === s && e.cost > 0) { ur[s] = e.rate !== undefined ? e.rate : (e.gain / e.cost) * 150; break; } } }); ur.total = st.reduce((a, s) => a + (ur[s] || 0), 0); return ur; }; const _snapAt = (cutoffMs, d, baseVals, baseRates) => { let vals = { ...baseVals }, rates = { ...baseRates }; if (d) { const ser = d.series || []; const dStart = d.startBreakdown || d.start; if (_hv(dStart)) vals = { ...dStart }; ser.filter(e => (e.ts * 1000) <= cutoffMs).forEach(e => { vals[e.stat] = e.after; }); st.forEach(s => { for (let i = ser.length - 1; i >= 0; i--) { const e = ser[i]; if (e.stat === s && e.cost > 0 && (e.ts * 1000) <= cutoffMs) { rates[s] = e.rate !== undefined ? e.rate : (e.gain / e.cost) * 150; break; } } }); rates.total = st.reduce((a, s) => a + (rates[s] || 0), 0); } return { vals, rates }; };
            if (vt === 'DAY') { const raw = DataController.getDateMap()[sl.date], start = startTs; xp.min = start; xp.max = start + 864e5; for (let i = 0; i <= 24; i += 2) labs.push(`${i}:00`); if (raw && raw.series) st.forEach(s => { if (sr[s] === 0) { const fLog = raw.series.find(l => l.stat === s); if (fLog && fLog.cost > 0) sr[s] = (fLog.gain / fLog.cost) * 150; } }); const ser = (raw && raw.series) ? raw.series : []; const sSt = (raw && (raw.startBreakdown || raw.start)) ? (raw.startBreakdown || raw.start) : (hist[0] && (hist[0].endBreakdown || hist[0].end)) ? (hist[0].endBreakdown || hist[0].end) : globalBaseline; const getSt = (ts) => { let r = { ...sSt }; ser.filter(s => (s.ts * 1000) <= ts).forEach(s => { r[s.stat] = s.after; }); return r; }; const getRt = (tsS, tsE) => { const rel = ser.filter(s => (s.ts * 1000) > tsS && (s.ts * 1000) <= tsE); if (rel.length === 0) return null; let et = 0, g = { ...ZERO_BREAKDOWN, total: 0 }, cs = { ...ZERO_BREAKDOWN }; rel.forEach(s => { et += s.cost; g[s.stat] += s.gain; g.total += s.gain; cs[s.stat] += s.cost; }); return { str: cs.str > 0 ? (g.str / cs.str) * 150 : 0, def: cs.def > 0 ? (g.def / cs.def) * 150 : 0, spd: cs.spd > 0 ? (g.spd / cs.spd) * 150 : 0, dex: cs.dex > 0 ? (g.dex / cs.dex) * 150 : 0, total: et > 0 ? (g.total / et) * 150 : 0 }; }; let lr = { ...sr }, now = Date.now(); const BKT = 15 * 60 * 1000; const sBkts = []; if (ser.length > 0) { const sorted = ser.filter(s => { const t = s.ts * 1000; return t >= start && t <= start + 864e5; }).sort((a, b) => a.ts - b.ts); let gS = -1, gL = -1; sorted.forEach(s => { const t = s.ts * 1000; if (gS < 0 || t - gS > BKT) { if (gL >= 0) sBkts.push(gL); gS = t; gL = t; } else { gL = t; } }); if (gL >= 0) sBkts.push(gL); } const used = new Set(), pts = []; for (let i = 0; i <= 24; i += 2) { const tick = start + (i * 3600 * 1000); if (isToday && tick > now) break; const nb = sBkts.find(b => !used.has(b) && Math.abs(b - tick) <= BKT); if (nb !== undefined) { used.add(nb); pts.push(nb); } else { pts.push(tick); } } sBkts.forEach(b => { if (!used.has(b)) pts.push(b); }); pts.sort((a, b) => a - b); pts.forEach(pt => { if (isR) { const rt = getRt(pt - BKT, pt); if (rt) { st.forEach(s => { if (rt[s] > 0) lr[s] = rt[s]; }); lr.total = st.reduce((a, s) => a + (lr[s] || 0), 0); } st.forEach(s => tr[s].push({ x: pt, y: lr[s] })); tr.total.push({ x: pt, y: lr.total }); } else { const sn = getSt(pt); st.forEach(s => tr[s].push({ x: pt, y: (sn[s] || 0) })); tr.total.push({ x: pt, y: (sn.str || 0) + (sn.def || 0) + (sn.spd || 0) + (sn.dex || 0) }); } }); }
            else if (vt === 'MONTH' || vt === 'WEEK') { const dl = sl._dailyList.sort((a, b) => a.date.localeCompare(b.date)); const byDate = {}; dl.forEach(d => byDate[d.date] = d); let runningRates = { ...sr }; let curVals = { ...globalBaseline }; const _prePeriodDay = hist.find(d => { const e = d.endBreakdown || d.end; return _hv(e); }); if (_prePeriodDay) curVals = { ...(_prePeriodDay.endBreakdown || _prePeriodDay.end) }; else if (dl.length > 0) { const f = dl[0].startBreakdown || dl[0].start; if (_hv(f)) curVals = { ...f }; } const todayStr = Formatter.dateLogical(); const nowMs = Date.now(); const _push = (x, vals, rates) => { st.forEach(s => tr[s].push({ x, y: isR ? rates[s] : (vals[s] || 0) })); tr.total.push({ x, y: isR ? rates.total : ((vals.str || 0) + (vals.def || 0) + (vals.spd || 0) + (vals.dex || 0)) }); }; if (vt === 'WEEK') { xp.min = 0; xp.max = 7; const fdStr = dl[0] ? dl[0].date : todayStr; const fd = Formatter.parse(fdStr); const dayIdx = fd.getUTCDay(); const weekOffset = userConfig.weekStartMode === 'mon' ? (dayIdx === 0 ? 6 : dayIdx - 1) : dayIdx; const weekStart = new Date(fd); weekStart.setUTCDate(fd.getUTCDate() - weekOffset); for (let i = 0; i < 7; i++) { const d = new Date(weekStart); d.setUTCDate(weekStart.getUTCDate() + i); labs.push(Formatter.dateISO(d.getUTCFullYear(), d.getUTCMonth(), d.getUTCDate())); } let _wkHasData = hist.length > 0; for (let i = 0; i < 7; i++) { const dateStr = labs[i]; const d = byDate[dateStr]; const dayStart = TimeManager.dayStartTs(dateStr); if (dayStart > nowMs) break; if (!d && !_wkHasData && dateStr !== todayStr) continue; if (d) _wkHasData = true; const middayTs = dayStart + 12 * 3600 * 1000; _push(i, curVals, runningRates); if (middayTs <= nowMs) { const m = _snapAt(middayTs, d, curVals, runningRates); _push(i + 0.5, m.vals, m.rates); } if (d) { if (dateStr === todayStr) { const live = _snapAt(nowMs, d, curVals, runningRates); curVals = live.vals; runningRates = live.rates; const liveX = i + Math.min((nowMs - dayStart) / 864e5, 1); _push(liveX, live.vals, live.rates); } else { const end = d.endBreakdown || d.end; if (_hv(end)) curVals = { ...end }; runningRates = _updRates(d, runningRates); } } } if (labs[6] < todayStr) _push(7, curVals, runningRates); } else { const yForMonth = year || new Date().getUTCFullYear(); const mIdx = CONSTANTS.MONTHS.indexOf(lbl); const dim = new Date(yForMonth, mIdx + 1, 0).getDate(); xp.min = 1; xp.max = dim + 1; for (let i = 1; i <= dim; i++) labs.push(String(i)); let _mHasData = hist.length > 0; for (let dayNum = 1; dayNum <= dim; dayNum++) { const dateStr = Formatter.dateISO(yForMonth, mIdx, dayNum); if (dateStr > todayStr) break; const d = byDate[dateStr]; if (!d && !_mHasData && dateStr !== todayStr) continue; if (d) _mHasData = true; _push(dayNum, curVals, runningRates); if (dateStr === todayStr) { if (!isR) { const startV = d && (d.startBreakdown || d.start); if (_hv(startV)) curVals = { ...startV }; } const _dayStart = TimeManager.dayStartTs(dateStr); const _frac = Math.min((nowMs - _dayStart) / 864e5, 1); const live = _snapAt(nowMs, d, curVals, runningRates); if (_frac > 0.005) _push(dayNum + _frac, live.vals, live.rates); curVals = live.vals; runningRates = live.rates; } else if (d) { if (isR) runningRates = _updRates(d, runningRates); else { const end = d.endBreakdown || d.end; if (_hv(end)) curVals = { ...end }; } } } if (Formatter.dateISO(yForMonth, mIdx, dim) < todayStr) _push(dim + 1, curVals, runningRates); } }
    ...
    */
    ...
    async function init() { injectStyles(); syncDevModeUI(); const _seenVer = localStorage.getItem(KEYS.CHANGELOG_VER); if (!_seenVer) { localStorage.setItem(KEYS.CHANGELOG_VER, SCRIPT_VERSION); } else if (_seenVer !== SCRIPT_VERSION) { localStorage.setItem(KEYS.CHANGELOG_NOTIF, '1'); } if (!runtime.demoMode) { try { await DBManager.initDB(); const stored = await DBManager.getStorage(); DataController.syncCache(stored); if (stored && ((_historyCache.history.length > 0) || (_historyCache.meta && _historyCache.meta.logStartDate)) && !localStorage.getItem('bbgl_initialized')) localStorage.setItem('bbgl_initialized', '1'); } catch (e) { console.warn('BBGL: IndexedDB boot failed, continuing with empty state', e); } } window.addEventListener('storage', handleStorageEvent); window.addEventListener('hashchange', checkViewRouting); window.addEventListener('popstate', checkViewRouting); window.addEventListener('bbgl:dataUpdated', () => renderPanelContent()); const domObs = new MutationObserver(() => handleDomMutation()); domObs.observe(document.body, { childList: true, subtree: true }); const layoutObs = new MutationObserver(() => { if (!runtime.layoutRafId) runtime.layoutRafId = requestAnimationFrame(() => { runtime.layoutRafId = null; handleLayout(); }); }); layoutObs.observe(document.body, { attributes: true, attributeFilter: ['class'], subtree: true }); calendarState.selectedLabel = Formatter.dateLogical(); window.devmode = (val) => { const mode = (val === 'on' || val === true); runtime.devMode = mode; sessionStorage.setItem(KEYS.DEV_MODE, mode); syncDevModeUI(); console.log(`BBGL: Developer mode ${mode ? 'ENABLED' : 'DISABLED'}`); }; if (!runtime.demoMode) { checkStaleness(); startBackgroundSync(); checkExitSync(); } document.addEventListener('click', handleGymClick); TooltipController.init(); let tRaf = null, tSup = 0; document.addEventListener('mousemove', (e) => { if (tRaf || Date.now() < tSup) return; tRaf = requestAnimationFrame(() => { TooltipController.handleHover(e); tRaf = null; }); }); let _tX = 0, _tY = 0, _tTimer = null, _scrubMode = false; document.addEventListener('touchstart', (e) => { document.body.classList.add('is-touch-device'); _tX = e.touches[0].clientX; _tY = e.touches[0].clientY; _scrubMode = false; window._bbglScrubbing = false; const t = TooltipController.resolve(e.target); if (t && t.hasAttribute('data-tooltip-html')) { _tTimer = setTimeout(() => { _scrubMode = true; window._bbglScrubbing = true; TooltipController.currentTarget = t; t.classList.add('is-scrub-hovered'); TooltipController.show(t.getAttribute('data-tooltip-html'), t.getBoundingClientRect()); }, 400); } }, { passive: true }); document.addEventListener('touchmove', (e) => { if (_scrubMode) { if (e.cancelable) e.preventDefault(); const touch = e.touches[0]; const el = document.elementFromPoint(touch.clientX, touch.clientY); const t = TooltipController.resolve(el); if (t && t.hasAttribute('data-tooltip-html')) { if (TooltipController.currentTarget !== t) { if (TooltipController.currentTarget) TooltipController.currentTarget.classList.remove('is-scrub-hovered'); TooltipController.currentTarget = t; t.classList.add('is-scrub-hovered'); TooltipController.show(t.getAttribute('data-tooltip-html'), t.getBoundingClientRect()); } } else { if (TooltipController.currentTarget) { TooltipController.currentTarget.classList.remove('is-scrub-hovered'); TooltipController.hide(); } } } else if (_tTimer) { const dx = e.touches[0].clientX - _tX, dy = e.touches[0].clientY - _tY; if (Math.sqrt(dx * dx + dy * dy) > 10) { clearTimeout(_tTimer); _tTimer = null; } } }, { passive: false }); document.addEventListener('touchend', (e) => { if (_tTimer) { clearTimeout(_tTimer); _tTimer = null; } if (_scrubMode) { if (e.cancelable) e.preventDefault(); if (TooltipController.currentTarget) { TooltipController.currentTarget.classList.remove('is-scrub-hovered'); TooltipController.hide(); } _scrubMode = false; window._bbglScrubbing = false; tSup = Date.now() + 500; return; } const dx = e.changedTouches[0].clientX - _tX, dy = e.changedTouches[0].clientY - _tY; if (Math.sqrt(dx * dx + dy * dy) > 10) { if (TooltipController.currentTarget) TooltipController.hide(); tSup = Date.now() + 500; return; } const t = TooltipController.resolve(e.target); if (t) { const h = t.getAttribute('data-tooltip-html'), txt = t.getAttribute('data-tooltip'); if (h) { if (TooltipController.currentTarget === t) TooltipController.hide(); } else if (txt) { if (TooltipController.currentTarget === t) TooltipController.hide(); else { TooltipController.currentTarget = t; TooltipController.show('<div style="text-align:center; color:#ddd;">' + txt + '</div>', t.getBoundingClientRect()); } } } else if (TooltipController.currentTarget) TooltipController.hide(); tSup = Date.now() + 500; }, { passive: false }); document.addEventListener('click', function (e) { const t = e.target.closest('#bbgl-gym-tab'); if (t) { e.preventDefault(); e.stopPropagation(); togglePanel(true); } }, true); handleDomMutation(); checkViewRouting(); if (!window.location.hash.includes('gymlog')) handleLayout(); }
    init();
})();